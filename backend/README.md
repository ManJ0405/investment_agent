...
![Alt text](backend/demo/stockanalyse.jpeg "Analyze stock")
...
├── db/
│   ├── data/
|   |   └── HSI.csv             # HSI constituents list
|   ├── schema/
|   |   └── core_table.sql      # Table setup
|   ├── __init__.py
|   ├── init_db.py              # Initialize table
|   └── load_csv.py             # Load data
├── pgdata/
...
|   ├── schemas/
|   |   ├── __init__.py
|   |   └── ticker_schema.py    # Define data input and vaildation
|   ├── __init__.py
